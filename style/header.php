...
<input type="text" placeholder="Search" class='saerch_'>
</div>
...
<div class="dropdown-cart-header">
    <!-- ===============  count itemmms  in view cart ========================= -->
<span class="item__">2 Items</span>
...
<a class="cart-img" href="product-details.php">   <img src="dashboard/images/<?=$products["img"]?>" alt="#"></a>
</div>
<div class="content">
<h4><a href="product-details.php">    <?php echo  $products["name"]?> </a></h4>
<p class="quantity"><span class="_count"><?=$value["count"]?></span> x-$ <span class="amount _price"><?=$products["price"]?></span></p>
</div>
</li>
<?php endforeach ?>
</ul>
