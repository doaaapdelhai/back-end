...
<span class="title">What payment methods do you accept?</span><i class="lni lni-plus"></i>
</button>
</h2>
...
<span class="title">Do I need an account to place an order?</span><i class="lni lni-plus"></i>
</button>
</h2>
...
<span class="title">Do you have discounts for returning customers?</span><i class="lni lni-plus"></i>
</button>
</h2>
...
<span class="title">What are the product refund conditions?</span><i class="lni lni-plus"></i>
</button>
</h2>
