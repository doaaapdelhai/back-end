...
<ul class="shopping-list">
    ...
    $cart=$connect->query("SELECT * FROM cart WHERE user_id=1");
    foreach ($cart as $key => $value):
        $product_id=$value["product_id"];

        $products=$connect->query("SELECT * FROM products WHERE id='$product_id' ")->fetch_assoc();

    
    ?>

<li class="li_cart">
<a href="javascript:void(0)" class="remove del_cart" id_pro='<?=$product_id?>'  title="Remove this item"><i class="lni lni-close"></i></a>
<div class="cart-img-head">

<a class="cart-img" href="product-details.html">   <img src="dashboard/images/<?=$products["img"]?>" alt="#"></a>
</div>
<div class="content">
<h4><a href="product-details.html">    <?php echo  $products["name"]?> </a></h4>
<p class="quantity"><?=$value["count"]?> x- <span class="amount">$<?=$products["price"]?></span></p>
</div>
</li>
<?php endforeach ?>
...
<img src="dashboard/images/<?php echo  $product["img"]?>  " style="height: 190; width:150px" alt="#">
<div class="button">
    <!-- =====================================cartttt===================== -->

<bottom href="product-details.html" id_pro="<?php echo  $product["id"]?> " class="btn _cart"><i class="lni lni-cart "></i> Add to Cart</bottom>
</div>
</div>
<div class="product-info">
<h4 class="title">
<a href="product-grids.html">Name :   <?php echo  $product["name"]?>  </a>
</h4>
...
<script>
    ...
    <!-- secript filllllllllllllllllllll -->
